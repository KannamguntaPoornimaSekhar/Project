...
def tab():
    ...
    tab1_b.place(x=300, y=30, height=60, width=220,)
...
def register():
    if entryname.get() == '' or entrymobilenumber.get()== '' or entryemail.get() == '' or entryaddress.get()=='' or\
        ...
        try:
            ...
            cur = con.cursor()
            cur.execute('select * from reg_volunty where Name=%s', entryname.get())
            ...
            if row != None:
                ...
                cur.execute('insert into reg_volunty (name, mobilenumber, emailid, address, pincode, password) values(%s,%s,%s,%s,%s,%s)',(entryname.get(),entrymobilenumber.get(),  entryemail.get(), entryaddress.get(),
...
titleLabel = Label(root, text='REGISTRATION FORM', font=('Times New Roman', 22, 'bold '), 
                   fg='black', )
titleLabel.place(x=350, y=100)

nameLabel = Label(root, text='Volunteers Name', font=('times new roman', 18, 'bold'), bg='white',
                       fg='black', )
nameLabel.place(x=250, y=180, width=200)
entryname = Entry(root, font=('times new roman', 18), bg='lightgray')
entryname.place(x=550, y=180, width=240)

mobilenumberLabel = Label(root, text='Mobile Number', font=('times new roman', 18, 'bold'), bg='white',
                      fg='black', )
mobilenumberLabel.place(x=250, y=230, width=200)
entrymobilenumber= Entry(root, font=('times new roman', 18), bg='lightgray')
entrymobilenumber.place(x=550, y=230, width=240)

emailLabel = Label(root, text='Email ID', font=('times new roman', 18, 'bold'), bg='white',
                     fg='black', )
emailLabel.place(x=250, y=290, width=200)
entryemail = Entry(root, font=('times new roman', 18), bg='lightgray')
entryemail.place(x=550, y=290, width=240)
...
pincodeLabel = Label(root, text='pincode', font=('times new roman', 18, 'bold'), bg='white',
                      fg='black', )
...
passwordLabel = Label(root, text='password', font=('times new roman', 18, 'bold'), bg='white',
                      fg='black', )
...
registerbutton.place(x=380, y=620)
